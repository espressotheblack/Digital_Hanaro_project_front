...
export function Component() {
  ...
  const sendSelectionToBackend = async (region, age) => {
    try {
      ...
      setChartData(response.data.data); // 받은 데이터를 상태에 저장
    } catch (error) {
      console.error('백엔드로 선택 사항 전송 중 오류 발생:', error);
    }
  };
      ...
      <section className="max-w-md mx-auto p-4" style={{ background: 'linear-gradient(to bottom, rgba(213, 241, 240, 0.9), #FFFFFF 60%)' }}>
        ...
        <section className="py-4" style={{ backgroundColor: '#FFFFFF' }}>
          ...
          <div className="flex overflow-x-auto space-x-4 py-4" style={{ width: '100%', flexShrink: 0 }}>
            {/* 첫 번째 카드 */}
            <div className="bg-white rounded-lg shadow-md p-4" style={{ minWidth: '400px', maxWidth: '600px', height: '300px' }}>
              <div className="flex flex-col h-full">
                ...
                <div className="flex flex-1 mb-4">
                  ...
                  <div className="w-1/2 pr-4">
                    {/* 그림 구역 */}
                    <img src="path_to_your_image" alt="Card Image" className="w-full h-auto rounded-lg" />
                  </div>
                  ...
                  <div className="w-1/2">
                    <div className="mb-4">
                      {/* 제목 */}
                      <h3 className="text-lg font-semibold mb-2">페르소나 1</h3>
                ...
                <div className="flex flex-wrap justify-center">
                  ...
                  <div className="w-full flex justify-center">
                    <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#tag4</span>
                    <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#tag5</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="flex flex-1 mb-4">
                  ...
                  <div className="w-1/2">
                    <div className="mb-4">
                      {/* 제목 */}
                      <h3 className="text-lg font-semibold mb-2">페르소나 2</h3>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="flex flex-1 mb-4">
                  ...
                  <div className="w-1/2">
                    <div className="mb-4">
                      {/* 제목 */}
                      <h3 className="text-lg font-semibold mb-2">페르소나 3</h3>
