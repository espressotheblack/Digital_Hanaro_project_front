        ...
        <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
          <div className="bg-white p-4 rounded-lg max-w-lg">
            <div className="flex justify-end">
              <button className="text-gray-600 hover:text-gray-800" onClick={() => setShowImage(false)}>
              ...
              <div className="flex items-center">
                <div className="relative">
                  <Select
                    ...
                    className="ml-5 w-[150px]"  // 필요한 마진을 조정합니다.
              ...
              <div className="flex items-center">
                <div className="relative">
                  <Select
                    ...
                    className="mr-2 w-[150px]" // 필요한 마진을 조정합니다.
